      ...
      <div className="space-y-4">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
          <p className="text-sm text-blue-800">
            ...
            <kbd className="px-2 py-1 bg-white border rounded">Esc</kbd> 键关闭对话框
          </p>
        </div>
      </div>
    ),
        ...
        <div className="bg-red-50 border border-red-200 rounded-md p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-red-800">删除账户后，所有数据将被永久清除，包括：</p>
...
export const Sizes: Story = {
  render: () => (
    <div className="flex gap-4">
      <Dialog
        trigger={
          <button className="px-3 py-2 bg-blue-600 text-white rounded-md text-sm">Small</button>
        }
        title="小尺寸对话框"
        size="sm"
      >
      ...
      <Dialog
        trigger={
          <button className="px-3 py-2 bg-blue-600 text-white rounded-md text-sm">Medium</button>
        }
        title="中等尺寸对话框"
        size="md"
      >
      ...
      <Dialog
        trigger={
          <button className="px-3 py-2 bg-blue-600 text-white rounded-md text-sm">Large</button>
        }
        title="大尺寸对话框"
        size="lg"
      >
      ...
      <div className="space-y-4">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          ...
          <ul className="space-y-1 text-sm text-green-800 list-disc list-inside">
            <li>
              自动添加 <code className="bg-white px-1 rounded">role="dialog"</code>
            </li>
            <li>
              自动添加 <code className="bg-white px-1 rounded">aria-modal="true"</code>
            </li>
            <li>焦点自动聚焦到对话框</li>
            <li>焦点锁定在对话框内</li>
            <li>关闭后焦点返回触发按钮</li>
